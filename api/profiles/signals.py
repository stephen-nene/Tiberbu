...
# from .models import HealthcareUser, Doctor, Patient, UserRole, UserStatus,ProfileImage
...
#         if hasattr(instance, '_profile_image_data'):
#             ProfileImage.objects.create(user=instance, **instance._profile_image_data)
